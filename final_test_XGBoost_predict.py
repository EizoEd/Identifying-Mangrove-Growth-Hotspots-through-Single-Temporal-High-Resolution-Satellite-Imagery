...
# Modify model to get output from the last convolutional layer
...
def clip_by_percentage(img, percentage=97, save_rate=0.1):
    ...
    print(f"{percentage}th percentile value is: {quantile}")
...
# File path list (keeping original Chinese paths as they appear to be actual filenames)
files = [
    f'湛江GF1B_PMS_20240402/湛江GF1B_PMS_20240402_ndvi_90m_feature.tif',
    f'湛江GF1B_PMS_20240402/湛江GF1B_PMS_20240402_ndwi_90m_feature.tif',
    f'湛江GF1B_PMS_20240402/湛江GF1B_PMS_20240402.tif',
    f'湛江GF1B_PMS_20240402/湛江GF1B_PMS_20240402_GLCM25_band1.tif',
    f'湛江GF1B_PMS_20240402/湛江GF1B_PMS_20240402_GLCM25_band2.tif',
    f'湛江GF1B_PMS_20240402/湛江GF1B_PMS_20240402_GLCM25_band3.tif',
    f'湛江GF1B_PMS_20240402/湛江GF1B_PMS_20240402_GLCM25_band4.tif'
]
output_filename = [
    f'湛江GF1B_PMS_20240402/湛江GF1B_PMS_20240402_湛江模型_XGBoost_predict.tif'
]

shapefile_paths = [
    '湛江红树林分布数据/mangroveage.shp'
]
...
model = joblib.load('zhanjiang_zhanjiang_XGBoost_depth10_lr0.1_100.joblib')

for idx, imgs in enumerate(trans):
    dmatrix = xgb.DMatrix(imgs)
    ...
    # Here 90m is -1, 150m is -2 because after reshaping at 150m, image becomes original dimensions *3+2
