...
def clip_by_percentage(img, percentage=97, save_rate=0.1):
    # Get the growth rate percentile at given percentage
...
output_filename = [
    f'ZhanjiangGF1B_PMS_20240402/ZhanjiangGF1B_PMS_20240402_ZhanjiangModel_RF_predict.tif'
]
...
model = joblib.load('zhanjiang_zhanjiang_RF_depth10_100.joblib')
